                    ...
                    {selectedUsers.length > 0 && (
                        <div className="flex flex-wrap gap-2">
                            {selectedUsers.map((u) => (
                                <span
                                    key={u._id}
                                    className="inline-flex items-center gap-1 bg-blue-100 text-blue-700 px-2.5 py-1 rounded-full text-sm"
                                >
                                    {u.username}
                    ...
                    {searchResults.map((u) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition text-left ${selected ? 'bg-blue-50 ring-1 ring-blue-200' : 'hover:bg-gray-50'
                                    }`}
                            >
